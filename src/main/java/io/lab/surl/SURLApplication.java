...
public class SURLApplication extends Application<SURLConfiguration> {
    ...
    public void run(final SURLConfiguration configuration, final Environment environment) {
        ...
        final DatabaseManager databaseManager = new DatabaseManager(configuration, environment);
        final UrlLookupDao urlLookupDao = databaseManager.getDao(UrlLookupDao.class);
